...
const { acmeMissions: missions } = loadTs(path.resolve(__dirname, '../lib/acme-missions.ts'));
...
console.log(`PASS: Acme ${missions.length} missions, ${total} states, all branches reachable and recoverable; completion cannot be skipped from start.`);
