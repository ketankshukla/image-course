...
From the `project-architecture` folder, rebuild with `companion-architecture-assets/rebuild.ps1`; rerun structural checks with `python companion-architecture-assets/verify.py`.
